...
module.exports = {
    name: 'chess-together-dev',
    aliases: ['chessdev'],
    description: 'Play Chess in the Park [DEV Version]',
    ...
    run: async (client, message, args) => {
        ...
        const finalembed = {
            title: 'Chess In The Park [DEV Version]',
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 3600,
                max_uses: 0,
                target_application_id: defaultApplications.chessdev,
                target_type: 2,
                temporary: false,
                validate: null
            }),
            ...
            const finalbutton = new MessageActionRow().addComponents(
                new MessageButton()
                    .setStyle("LINK")
                    .setLabel('Chess In The Park [DEV Version]')
