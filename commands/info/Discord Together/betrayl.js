...
module.exports = {
    name: 'betrayl.io',
    aliases: ['betrayl'],
    description: 'Play Betrayl.io Game',
    ...
    run: async (client, message, args) => {
        ...
        const error2 = {
            title: 'I was unable to start a Betrayl.io session! *P* *A* *I* *N*',
            color: '#2F3136'
        }
        const finalembed = {
            title: 'Betrayl.io',
            description: 'Click the Button below to play Betrayl.io in your VC',
            color: '#2F3136'
        }
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 3600,
                max_uses: 0,
                target_application_id: defaultApplications.betrayal,
                target_type: 2,
                temporary: false,
                validate: null
            }),
