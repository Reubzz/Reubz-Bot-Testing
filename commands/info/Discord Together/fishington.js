...
module.exports = {
    name: 'fishington',
    aliases: ['fishing'],
    description: 'Play Fishington in your VC',
    ...
    run: async (client, message, args) => {
        ...
        const error2 = {
            title: 'I was unable to start a Fishington session! *P* *A* *I* *N*',
            color: '#2F3136'
        }
        const finalembed = {
            title: 'Fishington',
            description: 'Click the Button below to play Fishington in your VC',
            color: '#2F3136'
        }
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 3600,
                max_uses: 0,
                target_application_id: defaultApplications.fishing,
                target_type: 2,
                temporary: false,
                validate: null
            }),
